...
$execute unless predicate bingo:$(consistent) in minecraft:overworld run bingospreadplayersseedfind 500 5 1500 $(respect_teams) @a[gamemode=!spectator] false #bingo:excluded
